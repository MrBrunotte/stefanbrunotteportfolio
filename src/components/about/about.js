        ...
        <Row>
            ...
            <Col xxl={8} xl={8} lg={8} md={12} sm={12} xs={12}>
                <div className="textArea">
                    ...
                    In addition to my IT background, I have been actively day-trading the futures markets on and off since 2005. Utilizing a price-action strategy, where I identify high-probability setups on the 2000-tick chart, focusing on E-Minis and Crude Oil. My ideal role would be one where I can merge my software development skills with my passion for trading.
                    </p>
